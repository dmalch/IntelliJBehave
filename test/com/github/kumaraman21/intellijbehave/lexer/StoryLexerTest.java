...
public class StoryLexerTest {
    ...
    public void parseMultilineLong() {
        ...
        advanceAndAssert(TokenType.WHITE_SPACE);
        advanceAndAssert(StoryTypes.GIVEN_STEP, "And");
        advanceAndAssert(TokenType.WHITE_SPACE);
        ...
        advanceAndAssert(TokenType.WHITE_SPACE);
        advanceAndAssert(StoryTypes.WHEN_STEP, "And");
        advanceAndAssert(TokenType.WHITE_SPACE);
        ...
        advanceAndAssert(TokenType.WHITE_SPACE);
        advanceAndAssert(StoryTypes.THEN_STEP, "And");
        advanceAndAssert(TokenType.WHITE_SPACE);
