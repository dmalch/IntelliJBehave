...
public class StoryLexerTest {
    ...
    public void parseMultilineLong() {
        ...
        advanceAndAssert(TokenType.WHITE_SPACE);
        advanceAndAssert(StoryTypes.GIVEN, "And");
        advanceAndAssert(TokenType.WHITE_SPACE);
        ...
        advanceAndAssert(TokenType.WHITE_SPACE);
        advanceAndAssert(StoryTypes.WHEN, "And");
        advanceAndAssert(TokenType.WHITE_SPACE);
        ...
        advanceAndAssert(TokenType.WHITE_SPACE);
        advanceAndAssert(StoryTypes.THEN, "And");
        advanceAndAssert(TokenType.WHITE_SPACE);
